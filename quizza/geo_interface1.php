...
<html>
    <head>
        ...
        <title>Geographical QuizzA</title>
        <link rel="stylesheet" href="geo_interface1.css">
    ...
    <body>
        ...
        <form class="teclevelform" name="form1" method="get">
        
          <br>
            <h2 class="log">Geographical QuizzA - Levels</h2>
            

        <div class="sign">
            <label>Basic Level</label>
            <button><a class="color" href="geo_interface2.php" required>Click me</a></button>
            </div><br>
        ...
        <div class="sign">
            ...
            <button><a class="color" href="geo_interface3.php" required>Click me</a></button>
            </div><br>

        <div class="sign">  
                <label>Hard Level</label>
                <button><a class="color" href="geo_interface4.php" required>Click me</a></button>
                </div><br>
